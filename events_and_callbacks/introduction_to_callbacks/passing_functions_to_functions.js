...
var animalToParrotTranslator = function(sentence) {
  return sentence.replace("animal", "parrot");
};
...
if (!module.parent) {
  ...
  console.log(favoriteAnimal(animalToParrotTranslator) === "parrots are the best!");
